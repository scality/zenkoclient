...
<ListBucketResult xmlns="http://s3.amazonaws.com/doc/2006-03-01/">
    ...
    <Contents>
        ...
        <Size>1024</Size>
        <Owner>
            <ID>19f06f46b3fbd39f51187e962a028da7ed3b29cf13faf2919d90907b2dafdabf</ID>
...
const expectedSearchResult = {
    ...
    Contents: [{
        ...
        Size: 1024,
        Owner: {
            ID: '19f06f46b3fbd39f51187e962a028da7ed3b29cf13faf2919d90907b2dafdabf',
            DisplayName: 'orbit',
        },
...
describe('class ZenkoClient JSON api', () => {
    ...
    describe('ZenkoClient::listFailed', () => {
        it('should return empty list response when sitename is not given', done => {
